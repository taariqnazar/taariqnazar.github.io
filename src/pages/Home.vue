<template>
  ...
  <ul class="text-slate-500 flex space-x-4 my-5 text-gray-600">
    <li>
      <a href="https://github.com/taariqnazar"
        title="GitHub"
        class=" hover:text-gray-800">
      <span 
        class="[&>svg]:h-7 [&>svg]:w-7 hover:scale-110">
        <svg
    ...
    <li>
      <a href="https://www.linkedin.com/in/taariq-nazar-060719bb/"
        title="LinkedIn"
    ...
    <li>
      <a href="https://scholar.google.com/citations?user=3eZbj84AAAAJ&hl"
